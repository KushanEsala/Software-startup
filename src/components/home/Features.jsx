...
const features = [
  ...
  },
  {
    ...
    description: 'Our designs are intuitive and user-friendly, ensuring a seamless experience for your customers.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'We follow agile methodologies to deliver high-quality software iteratively and efficiently.',
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
